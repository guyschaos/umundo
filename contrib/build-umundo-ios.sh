...
if [ ! -d core ]; then
	echo
	echo "Cannot find umundo"
	echo "Run script from umundo directory:"
	echo "umundo$ ./contrib/${ME}"
	echo
	exit
fi
...
if [[ -z $1 || $1 = "Debug" ]] ; then
cd ${BUILD_DIR}
rm -rf * && cmake ${DIR}/../ -DCMAKE_TOOLCHAIN_FILE=${CWD}/contrib/cmake/CrossCompile-iOS-Sim.cmake -DCMAKE_BUILD_TYPE=Debug && make -j2
rm -rf * && cmake ${DIR}/../ -DCMAKE_TOOLCHAIN_FILE=${CWD}/contrib/cmake/CrossCompile-iOS.cmake -DCMAKE_BUILD_TYPE=Debug && make -j2
...
cd ${BUILD_DIR}
rm -rf * && cmake ${DIR}/../ -DCMAKE_TOOLCHAIN_FILE=${CWD}/contrib/cmake/CrossCompile-iOS-Sim.cmake -DCMAKE_BUILD_TYPE=Release && make -j2
rm -rf * && cmake ${DIR}/../ -DCMAKE_TOOLCHAIN_FILE=${CWD}/contrib/cmake/CrossCompile-iOS.cmake -DCMAKE_BUILD_TYPE=Release && make -j2
